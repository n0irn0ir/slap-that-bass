...
const en = {
  ...
  'ach.new': 'New sticker',
  'ach.ok': 'Nice',
  'ach.first_entry.name': 'First entry',
  'ach.first_entry.desc': 'The journal has a page.',
  'ach.first_song.name': 'Song in the journal',
  'ach.first_song.desc': 'A song showed up in a session.',
  'ach.three_things.name': 'Three things at once',
  'ach.three_things.desc': 'One session, three or more lines.',
  'ach.two_hours.name': 'Two hours',
  'ach.two_hours.desc': 'A single session of two hours or more.',
  'ach.all_six.name': 'All six',
  'ach.all_six.desc': 'Every category inside one week.',
  'ach.first_learned.name': 'One down',
  'ach.first_learned.desc': 'A song moved to learned.',
  'ach.ten_topics.name': 'Ten topics',
  'ach.ten_topics.desc': 'Ten different topics with time on them.',
  'ach.five_faces.name': 'All the faces',
  'ach.five_faces.desc': 'Every rating used at least once. Honest.',
  'ach.comeback.name': 'Comeback',
  'ach.comeback.desc': 'Back after two weeks or more. That is the whole trick.',
  'ach.note_taker.name': 'Note taker',
  'ach.note_taker.desc': 'Ten entries with a note.',
...
const ru: Record<Key, string> = {
  ...
  'dash.pAll': 'Всё время',
  'ach.title': 'Стикеры',
  'ach.new': 'Новый стикер',
  'ach.ok': 'Отлично',
  'ach.first_entry.name': 'Первая запись',
  'ach.first_entry.desc': 'В дневнике появилась страница.',
  'ach.first_song.name': 'Песня в дневнике',
  'ach.first_song.desc': 'В сессии появилась песня.',
  'ach.three_things.name': 'Три дела разом',
  'ach.three_things.desc': 'Одна сессия, три строки или больше.',
  'ach.two_hours.name': 'Два часа',
  'ach.two_hours.desc': 'Одна сессия от двух часов.',
  'ach.all_six.name': 'Все шесть',
  'ach.all_six.desc': 'Все категории за одну неделю.',
  'ach.first_learned.name': 'Одна готова',
  'ach.first_learned.desc': 'Песня переехала в выученные.',
  'ach.ten_topics.name': 'Десять тем',
  'ach.ten_topics.desc': 'Десять разных тем с временем.',
  'ach.five_faces.name': 'Все лица',
  'ach.five_faces.desc': 'Каждая оценка хоть раз. Честно.',
  'ach.comeback.name': 'Возвращение',
  'ach.comeback.desc': 'Снова после двух недель или больше. В этом весь фокус.',
  'ach.note_taker.name': 'С заметками',
  'ach.note_taker.desc': 'Десять записей с заметкой.',
