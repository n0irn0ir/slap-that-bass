...
const en = {
  ...
  'dash.songs': 'Songs',
  'dash.recent': 'Recent',
  'dash.recentEmpty': 'Your journal will show up here.',
  'dash.fullLog': 'Open the journal',
  'dash.rhythm': 'Rhythm',
...
const ru: Record<Key, string> = {
  ...
  'dash.recentEmpty': 'Здесь появятся записи из дневника.',
  'dash.fullLog': 'Весь дневник',
  'dash.rhythm': 'Ритм',
