...
const en = {
  ...
  'log.none': '— none —',
  'log.topicPlaceholder': 'Pick one or type a new one',
  'log.createTopic': 'New topic in {cat}: “{title}”',
  'log.minutes': 'Minutes',
  'log.min': 'min',
...
const ru: Record<Key, string> = {
  ...
  'log.none': '— без темы —',
  'log.topicPlaceholder': 'Выбери или впиши новую',
  'log.createTopic': 'Новая тема в «{cat}»: «{title}»',
  'log.minutes': 'Минуты',
  'log.min': 'мин',
